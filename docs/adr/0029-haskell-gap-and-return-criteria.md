# ADR-0029: Haskell capability gap and return criteria
...
- Relates to: ADR-0015, ADR-0028, ADR-0030.
- Supersedes: feature branch ADR-0016 numbering only.
- Main contract: ADR-0015 structural corpus gate.
- Contract version: Haskell import/quarantine v1.
- Reference vectors: `qxfx0-semantic` corpus import tests and `data/imports/`.
