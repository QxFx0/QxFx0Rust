# ADR-0030: Knowledge Pack Framework v1
...
- Relates to: ADR-0028, ADR-0031.
- Supersedes: feature branch ADR-0017 numbering only.
- Main contract: ADR-0014 audited content plan.
- Contract version: Knowledge Pack v1; additive SQLite schema v9.
- Reference vectors: `qxfx0-semantic` knowledge-pack tests and pack manifests.
